...
function Fits = BlackBoxfunctionTwoBeams(chromosome)
...
% (chromosome) that encodes one device to be simulated and output tow 
...
global Propagator TargetFieldG TargetFieldH mult loss
...
Field=InputFieldH;                                                          % simulation for the Hermite Gauss field folowing the same steps
for hh=1:devStepz
...
Fits=[FitsG,FitsH];                                                         % results values to be minimize
end
